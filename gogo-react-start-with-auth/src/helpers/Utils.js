...
export const getToken = () => {
  ...
  try {
    token =
      localStorage.getItem('gogo_Token') != null
        ? JSON.parse(localStorage.getItem('gogo_Token'))
        : null;
  } catch (error) {
...
export const setToken = (user) => {
  try {
    if (user) {
      localStorage.setItem('gogo_Token', JSON.stringify(user));
    } else {
      localStorage.removeItem('gogo_Token');
    }
  } catch (error) {
